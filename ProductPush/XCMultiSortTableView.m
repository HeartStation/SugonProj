...
- (UITableViewCell *)leftHeaderTableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    label.textColor = [UIColor colorWithRed:0x22/255.0 green:0x22/255.0 blue:0x22/255.0 alpha:1.0];
    // 允许多行显示
    label.numberOfLines = 0;
    label.textAlignment = UITextAlignmentCenter;
//    [label sizeToFit];
...
//    NSMutableArray *ary = [contentDataArray objectAtIndex:indexPath.row];
